...
setup(
    ...
    packages=[
        ...
        "flask_fd.plop.flask.starter.flaskapp.app",
        "flask_fd.plop.flask.starter.flaskapp.app.templates",
        "flask_fd.plop.flask.starter.flaskapp.app.static",
        "flask_fd.plop.flask.starter.flaskapp.app.static.css",
        "flask_fd.plop.flask.starter.flaskapp.app.static.img",
